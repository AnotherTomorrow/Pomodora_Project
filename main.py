...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        time.config(text="Working", fg=GREEN)
...
time = Label(text="Timer", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 45, "bold"))
...
check_mark = Label(fg=GREEN, bg=YELLOW, font=10, pady=10, padx=10)
